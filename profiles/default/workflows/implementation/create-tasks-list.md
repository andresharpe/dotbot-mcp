...
2. **Plan task execution order**: Break the requirements into tasks in an order that accounts for dependencies
...
- [ ] 4.0 Review existing tests and fill critical gaps only
  - [ ] 4.1 Review tests from Task Groups 1-3
    ...
    - Review the 2-8 tests written in Task 2.1
    - Review the 2-8 tests written in Task 3.1
...
- **Group related tasks:** Group backend engineering tasks together and frontend UI tasks together
- **Limit test writing during development**:
  ...
  - If there is a dedicated test coverage group, it should add only a maximum of 10 additional tests IF NECESSARY
- **Use a focused test-driven approach** where each task group starts with writing 2-8 tests and ends with running ONLY those tests
